  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="relative grid h-10 w-10 shrink-0 place-items-center rounded-lg border border-slate-200 text-slate-600 transition hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-brand-green/40 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800"
          ...
          <div className="flex items-center justify-between border-b border-slate-100 px-4 py-3 dark:border-slate-700">
            ...
            {unreadCount > 0 && (
              <button
                ...
                className="text-xs font-semibold text-brand-green hover:text-brand-green-dark dark:text-brand-lime-light dark:hover:text-brand-lime"
              >
                    ...
                    >
                      <span
                        className={`mt-1.5 h-2 w-2 shrink-0 rounded-full ${
                          isUnread ? "bg-brand-green" : "bg-transparent"
                        }`}
                        aria-hidden="true"
                      />
