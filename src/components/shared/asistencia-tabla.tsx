...
export default function AsistenciaTabla({
  ...
  return (
    <>
      ...
      <div className="hidden overflow-x-auto rounded-lg border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-900 md:block print:block">
