  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="flex min-w-0 items-center gap-2.5 rounded-lg p-1 pr-1.5 transition hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-brand-green/40 dark:hover:bg-slate-800 sm:pr-2"
      ...
      >
        ...
        <UserAvatar
          ...
          className="h-9 w-9 bg-brand-green text-sm font-bold text-white"
        />
      </button>
