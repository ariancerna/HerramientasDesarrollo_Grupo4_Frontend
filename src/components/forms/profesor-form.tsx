...
export default function ProfesorForm({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/40 px-4 py-4 sm:py-6">
      <div ref={dialogRef} tabIndex={-1} role="dialog" aria-modal="true" aria-labelledby="profesor-form-title" className="my-auto w-full max-w-lg rounded-2xl border border-slate-200 bg-white p-4 shadow-lg dark:border-slate-700 dark:bg-slate-900 sm:p-6">
        <h2 id="profesor-form-title" className="text-lg font-bold text-slate-950 dark:text-white">
        ...
        <form onSubmit={handleSubmit} className="mt-5 grid gap-4 sm:grid-cols-2">
          ...
          <div className="mt-2 flex justify-end gap-3 sm:col-span-2">
            ...
            <button
              ...
              className="rounded-lg bg-primary px-4 py-2.5 text-sm font-bold text-white transition hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60"
            >
              Guardar
            </button>
          </div>
