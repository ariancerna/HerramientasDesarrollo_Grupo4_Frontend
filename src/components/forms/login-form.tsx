      ...
      <form onSubmit={handleSubmit} noValidate className="space-y-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`h-14 w-full rounded-xl border bg-bg-auth pl-12 pr-12 text-[15px] text-ink outline-none transition placeholder:text-muted focus:border-primary focus:bg-surface focus:ring-4 focus:ring-primary/10 ${
        ...
        <button
          type="submit"
          disabled={loading}
          className="flex h-14 w-full items-center justify-between rounded-xl bg-primary px-6 text-[15px] font-bold text-white shadow-[0_4px_16px_rgba(21,128,61,0.28)] transition hover:bg-primary-hover disabled:cursor-not-allowed disabled:opacity-60"
        >
