      ...
      <form onSubmit={guardar} className="mt-5 space-y-4">
        ...
        <label>
          ...
          <textarea
            ...
            className="w-full resize-y rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-slate-900 outline-none focus:border-brand-green focus:ring-2 focus:ring-brand-lime/30 dark:border-slate-600 dark:bg-slate-800 dark:text-white"
        ...
        <div className="flex justify-end gap-3 border-t border-slate-100 pt-4 dark:border-slate-800">
          ...
          <button type="submit" className="rounded-lg bg-brand-green px-4 py-2.5 text-sm font-bold text-white hover:bg-brand-green-dark">
            Guardar evaluación
          </button>
        </div>
      </form>
