  ...
  return (
    <article className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
      <div className="flex items-start justify-between gap-4">
        ...
        <span className={`rounded-full px-2.5 py-1 text-xs font-semibold ${anuncio.estado === "enviado" ? "bg-primary-soft text-primary-dark" : "bg-amber-100 text-amber-700"}`}>
      ...
      <div className="mt-4 flex justify-end gap-3 border-t border-slate-100 pt-3 dark:border-slate-800">
        <button type="button" onClick={() => onEditar(anuncio)} className="text-sm font-semibold text-primary-dark hover:text-primary-hover">Editar</button>
