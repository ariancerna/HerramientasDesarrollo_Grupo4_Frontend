  ...
  return (
    <article className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
      <div className="flex items-start justify-between gap-4">
        ...
        <span className="rounded-full bg-[#edf8e8] px-2.5 py-1 text-xs font-semibold text-[#16794C]">
          Asignado
        </span>
      </div>
      ...
      <p className="mt-1 text-sm text-slate-500">Entrenamiento de categoría</p>
    </article>
  );
}