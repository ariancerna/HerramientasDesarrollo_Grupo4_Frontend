  ...
  return (
    <label className="text-sm font-semibold text-slate-700 dark:text-slate-300">
      ...
      <select
        ...
        className="rounded-lg border border-slate-300 bg-white px-3 py-2 font-normal text-slate-800 outline-none focus:border-brand-green focus:ring-2 focus:ring-brand-lime/30 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-100"
      >
